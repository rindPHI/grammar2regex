...
setup(
    ...
    description="Conversion of a (sub) grammar to (approximated) regular expressions",  # Optional
    ...
    url="https://projects.cispa.saarland/c01dost/grammartoregex",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Dominic Steinhofel",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="dominic.steinhoefel@gmail.com",  # Optional
    ...
    install_requires=[
        "appnope==0.1.2; sys_platform == 'darwin' and platform_system == 'Darwin' and sys_platform == 'darwin' and platform_system == 'Darwin'",
        "argon2-cffi==20.1.0",
        ...
        "ipykernel==5.5.4; python_version >= '3.5'",
        ...
        "ptyprocess==0.7.0; os_name != 'nt' and os_name != 'nt'",
