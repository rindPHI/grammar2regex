...
GREP_GRAMMAR: Grammar = {
    ...
    "<printf>": ["printf " "<input_>" " | "],
    "<command>": ["<cmd_1><ws><patterns>"],
    "<cmd_1>": ["<general_options>"],
    "<program>": ["timeout 0.5s grep"],
    ...
    "<patterns>": ["<pattern>", "-e <pattern>", "--regexp=<pattern>"],
    "<matcher_selection>": ["<extended_regex>", "<fixed_string>", "<regexp>"],
    "<matching_control>": [
        "<ignore_case>",
        "<invert_match>",
        "<word_match>",
    ...
    "<grep_colors_value>": [
        "<color_options>",
        "<color_options>" ":" "<grep_colors_value>",
        "<empty>",
    ],
    "<color_options>": [
        "sl=" "<sgr>",
